...
tf._api.v2.image.resize_images = tf._api.v2.image.resize
...
class ScoringService(object):
    @classmethod
    def get_model(cls, model_path='../model/small_resolution_resnet50_csv_11.h5'):
        """
        ...
        try:
            ...
            cls.model = models.load_model('../model/small_resolution_resnet50_csv_11.h5', backbone_name='resnet50') 
    ...
    def predict(cls):
        ...
        predictions = []
        cap_pipeline = "nvarguscamerasrc !  video/x-raw(memory:NVMM), width=1280, height=720, format=(string)NV12, framerate=(fraction)60/1 !  nvvidconv flip-method=0  !  video/x-raw, width=640, height=360, format=(string)BGRx !  videoconvert !  video/x-raw, format=(string)BGR !  appsink "
        ...
        out = cv2.VideoWriter(out_pipeline, cv2.CAP_GSTREAMER, 0, 28, (640, 360))
